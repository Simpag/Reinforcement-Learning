...
class Snake_16x16_Big_Apple_Reward(SnakeEnv):
    def __init__(self):
...
class Snake_16x16_Heatmap_big_reward_5_apples(SnakeEnv):
    def __init__(self):
        super().__init__(grid_type=GridType.heatmap, grid_size=16, reward_apple=20, num_apples=5)
